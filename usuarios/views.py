    ...
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            if tipo_usuario == 'Conductor':
                ...
                return render(request, 'VistaInicioDeSesion.html', {'error': 'Tipo de usuario incorrecto'})
        else:
            return render(request, 'VistaInicioDeSesion.html', {'error': 'Credenciales de usuario incorrectas'})
    else:
        csrf_token = get_token(request)
        return render(request, 'VistaInicioDeSesion.html', {'csrf_token': csrf_token})
...
def vista_login(request):
    return render(request, 'VistaInicioDeSesion.html')
